...
def main():
    fbx_file = "D:/workSpace/Python/Tools/publish/AssetBrowser/test/test_FBX_SDK/myFbxSaveFile.fbx"
    output_file = "D:/workSpace/Python/Tools/publish/AssetBrowser/test/test_FBX_SDK/myFbxSaveFile.fbx"
