...
def load_custom_module(plugin_file, valid_base_class, alternate_base_classes=None):
    """
    ...
    :raises:                        Raises a Error if it fails to load the file or doesn't find exactly
                                    one matching class.
    """
    ...
    try:
        ...
        # calling code is doing, this error is logged to help
        # with troubleshooting and support
        print("Failed to introspect hook structure for '%s'" % plugin_file)

        print("ERROR:Introspection error while trying to load and introspect file %s. "
